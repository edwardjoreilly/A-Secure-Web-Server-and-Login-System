    ...
    if(isset($_POST["submit"])) {
        ...
        if($password == $password2) {
	        ...
	        //Then redirect the user to the Registration Success page
                ...
                last_name, birthday, user_email, securityq1, securityq2, securityq3) 
                VALUES ('$username','$password', '$firstname', '$lastname', '$birthday', '$email', '$securityq1', '$securityq2', '$securityq3')";
	            $results = mysqli_query($dbHandle, $query);
                $_SESSION['username'] = $username;
	            header("location: http://172.18.30.210//regSuccess.php");
	        }
        }
...
<html>
	...
	<form name="form" method="post" action="http://172.18.30.210//reg.php">
